...
export default function TraditionSection() {
  return (
    <section className="relative w-full min-h-screen py-20 lg:py-28 bg-white overflow-hidden font-sans flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-[#11052C] hover:bg-[#200a4d] text-white text-xs sm:text-sm font-bold px-8 py-4 rounded-full shadow-lg shadow-purple-900/10 transition-all duration-200 flex items-center gap-3 group cursor-pointer"
            >
