...
export default function WestminsterHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-2 inset-0 z-0 select-none pointer-events-none">
        <img
         ...
         >
           ...
           <motion.div className="lg:col-span-7 xl:col-span-6 flex flex-col items-start" variants={itemVariants}>
             ...
             <motion.div className="flex flex-wrap items-center gap-4" variants={itemVariants}>
               <motion.button 
                 className="bg-[#EAB308] hover:bg-[#D97706] text-white font-bold text-sm sm:text-base px-8 py-3.5 rounded-full shadow-lg shadow-amber-500/20 transition-all duration-200 active:scale-95"
               ...
               <motion.button 
                 className="bg-[#0B031A] hover:bg-[#200A40] text-white font-bold text-sm sm:text-base px-8 py-3.5 rounded-full shadow-lg transition-all duration-200 active:scale-95"
                 whileHover={{ scale: 1.05 }}
                 whileTap={{ scale: 0.95 }}
               >
                 Get Event Tickets
