...
export default function TestimonialsSection() {
  return (
    ...
    shadow-lg
    hover:shadow-[0_20px_60px_rgba(91,33,182,0.18)]
    hover:border-[#5B21B6]
    transition-all
    duration-500
    cursor-pointer
...
"
          >            <div>
              <div className="flex gap-1 text-[#5B21B6] mb-6 transition-all duration-500 group-hover:scale-110">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    size={16}
                    className="fill-[#5B21B6] transition-all duration-500 group-hover:rotate-12"
                  />
                ))}
              </div>
