...
export default function SignatureEvents() {
  const events = [
    ...
    },
    {
      ...
      image: "2e1af57df64f58375a9e22b43d15eddea9b58096.png",
    ...
    },
    {
      ...
      image: "/b83475685481bbcf5ec54cf6de1599085d735f25.png",
  ...
  return (
    <motion.section 
      className="w-full min-h-screen py-20 bg-white font-sans"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <motion.div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" variants={containerVariants}>
         ...
         {/* ================= HEADER SECTION ================= */}
         <motion.div className="flex flex-col lg:flex-row lg:items-end justify-between mb-14 gap-6" variants={itemVariants}>
